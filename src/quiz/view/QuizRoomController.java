...
public class QuizRoomController extends EventPublisher {
	...
	public class QuizroomHandler implements EventListener {
		public void handleEvent(Event e) {
			if (e != null) {
				...
				System.out.println("received_null_event");
		}
	}
	...
	private void handleJoin() {
		...
		if (selectedTeam != null) {
			...
			if (selectedTeam.getTeamID() != Context.getContext().getTeamID() && currCaptainID != currUser.getID()) {// user
																													// nog
																													// niet
																													// in
																													// dit
																													...
																													// never
																													// -1)
				ChangeTeamEvent changeTeamEvent = new ChangeTeamEvent(Context.getContext().getQuiz().getQuizID(),
						selectedTeam.getTeamID(), currTeamID, currUser.getID());
				publishEvent(changeTeamEvent);
				/*
				 * selectedTeam.getTeamMembers().put(currUser.getID(),currUser.
				 * getUsername()); showTeamDetails(selectedTeam);
				 */
				// TODO error handling,
			}
		}
